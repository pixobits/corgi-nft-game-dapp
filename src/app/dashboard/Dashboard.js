            ...
            <div className="card corona-gradient-card">
              <div className="card-body py-0 px-0 px-sm-3">
                <div className="row align-items-center">
                  <div className="col-4 col-sm-3 col-xl-2 py-3">
                  ...
                  <div className="col-5 col-sm-7 col-xl-8 p-0">
                    ...
                    <p className="mb-0 font-weight-normal d-none d-sm-block">Corgi Token Game now with a new facelift for enhanced legibility and aesthetics!</p>
                  </div>
